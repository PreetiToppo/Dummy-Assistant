...
#here is the exceution functions i made it, so that the main code looks a bit clean 
def showmagic():
    dummy_input_mode= mode_select()
    while True:
        playsound.playsound(os.path.join('soundeffects\sfx',"howcanihelpyounow.mp3"))
        print("\nTell Me How Can I Help you Now ?")
        statement=take_input(dummy_input_mode)
        ...
        if statement==None:
            ...
            time.sleep(3)
                ...
                note_text = take_input(dummy_input_mode)
                note(note_text)
                speak("I have made a note of that.")

        elif "weather" in statement:
            api_key="da7e51dea361a3f682aabe5b591a3d71"  #API KEY REQUIRED HERE
            base_url="https://api.openweathermap.org/data/2.5/weather?"
            playsound._playsoundWin(os.path.join('soundeffects\sfx',"cityname.mp3"))
            print("\nwhats the city?")
            city_name= take_input(dummy_input_mode)
            ...
            query=take_input(dummy_input_mode)
            client = wolframalpha.Client('4936TT-6AV6EA57GK') #API KEY REQUIRED HERE
            ...
            print('''
            I was born on november 2021 by A group Who Had an Ambition To Change This World with the
            ...
            print('I am dummy your Persoanl AI assistant. I am programmed for managing normal tasks in your Life')
            speak("I am dummy your Persoanl AI assistant. I am programmed for managing normal tasks in your Life")
            time.sleep(3)

        elif 'your name' in statement or 'what is your name' in statement :
            speak("my name is dummy, how could you forget me :-(")
            print('my name is dummy your A.I assistant')
            time.sleep(3)
            ...
            speak("I was built by my great all mighty masters, Preeti,Ankush and Vulpala")
            print("I was built by Preeti,Ankush and Vulpala")
            time.sleep(2)
            ...
            from minigamesmanager import playgame
            playgame()
            time.sleep(3)
